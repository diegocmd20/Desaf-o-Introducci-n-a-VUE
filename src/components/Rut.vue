<script>
    export default{
        ...
        data(){
            return{
                rut: '15.364.458-7',
                nombres: 'Diego Stefano',
                apellido: 'Moran',
                nacionalidad: 'Chilena',
                sexo: 'Masculino',
                nacimiento: '07-09-1999',
                documento: '654.456.156',
                emision: '15-3-2023',
                vencimiento: '15-3-2028',
                firma: 'Diegostefan'
            }
        }
    }
    ...
    <div class="carnet">
      <aside>
        <div>
          ...
          <img width="40" src="../assets/chile_bandera.png" alt="Bandera" />
        </div>

        <img src="../assets/foto_elon.jpg" alt="Elon" />
        <p>RUN {{rut}}</p>
      </aside>
